...
const Login = () => {
  ...
  const [isPasswordFocusedOrFilled, setIsPasswordFocusedOrFilled] =
    useState(false);
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (userNameResponse.ok) {
          ...
          console.error(
            "userName을 가져오지 못했습니다.",
            userNameResponse.statusText
          );
          alert(
            `userName을 가져오지 못했습니다.: ${userNameResponse.statusText}`
          );
        }
    ...
    <>
      ...
      <LoginContainer>
        ...
        <Field>
          ...
          />
          <Label for="username" isFocusedOrFilled={isFocusedOrFilled}>
            이메일(ID)
          </Label>
        </Field>
        <Field>
